...
switch(@$_GET['act']){
  ...
  default:
    ...
    echo "</tbody></table>";
    echo "<p><b>Notice=</b> Data Menu tidak bisa dihapus, tapi bisa di non-aktifkan melalui Edit menu<br><p><br>";
    break;
  ...
  case "editmenuutama":
    ...
    echo "<tr><td class='left'colspan=2><input type=submit value=Update>
                            <input type=button value=Batal onclick=self.history.back()></td></tr>
          <tbody></table></form>
          <p><b>Notice=</b>Bila Aktif = Y dan Admin Menu = N, maka Menu Utama ditampilkan di halaman pengunjung.
 	       Apabila Aktif = N dan Admin Menu = Y, ditampilkan di halaman administrator</p>
         </div><br>";
    break;  
}
}
