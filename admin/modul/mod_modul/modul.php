...
switch(@$_GET['act']){
  ...
  default:
    echo "<h2>Modul</h2>
<input type=button value='Tambah Modul' onclick=\"window.location.href='?module=modul&act=tambahmodul';\"><br />
  ...
  case "tambahmodul":
    echo "<h2>Tambah Modul</h2>
		  ...
		  <input type=hidden name=id_modul>
          <table class='list'><tbody>
          <tr><td class='left'>Nama Modul</td> <td> : <input size=30 type=text name='nama_modul'></td></tr>
          ...
          <tr><td class='left'>Aktif</td>      <td> : <input type=radio name='aktif' value='Y' checked>Y  <input type=radio name='aktif' value='N'> N</td></tr>
          <tr><td class='left'>Status</td>     <td> : <input type=radio name='status' value='admin' checked>admin 
			...
			<tr><td class='left'>Urutan</td> <td> : <input size=30 type=number name='urutan'></td></tr>
