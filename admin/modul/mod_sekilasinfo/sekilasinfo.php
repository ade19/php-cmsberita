...
switch(@$_GET['act']){
  ...
  case "tambahsekilasinfo":
      echo "<h2>Tambah Sekilas Info</h2>
          ...
          <tr><td class='left'>Info</td><td class='left'>  : <input type=text name='info' size=80></td></tr>
  ...
  case "editsekilasinfo":
    ...
    echo "<h2>Edit Sekilas Info</h2>
          ...
          <table class='list'><tbody>          <tr><td class='left'>Info</td><td class='left'>     : <input type=text name='info' size=80 value='$r[info]'></td></tr>
