...
switch(@$_GET['act']){
  ...
  default:
    echo "<h2>Galeri Foto</h2>
          ...
          <th class='center'>gambar foto</th>
          <th class='left'>judul foto</th>
          <th class='left'>album</th>
          <th class='center'>aksi</th></tr></thead><tbody>";

    $tampil = mysql_query("SELECT * FROM gallery,album WHERE gallery.id_album=album.id_album ORDER BY id_gallery");
  ...
  case "tambahgalerifoto":
    ...
    echo "</select></td></tr>
          <tr><td class='left'>Keterangan</td>  <td class='left'> <textarea id='loko' name='keterangan' style='width: 490px; height: 150px;'></textarea></td></tr>
  ...
  case "editgalerifoto":
    ...
    echo "</select></td></tr>
          <tr><td class='left'>Keterangan</td>   <td class='left'> <textarea id='loko' name='keterangan' style='width: 490px; height: 150px;'>$r[keterangan]</textarea></td></tr>
