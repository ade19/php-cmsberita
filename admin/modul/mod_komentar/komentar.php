...
switch(@$_GET['act']){
  ...
  default:
    ...
    $tampil=mysql_query("SELECT * FROM komentar ORDER BY id_komentar");
  ...
  case "editkomentar":
    ...
    echo "<h2>Edit Komentar</h2>
          ...
          <tr><td class='left'>Isi Komentar</td><td class='left'> <textarea name='isi_komentar' id='loko' style='width: 490px; height: 150px;'>$r[isi_komentar]</textarea></td></tr>";
