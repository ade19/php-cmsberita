  ...
  <div class="lof-main-outer">
  	<ul style="left: -747.701px; width: 3000px;" class="lof-main-wapper">
            ...
            <div style="height: 300px; width: 310px;" class="lof-navigator-outer">
              ...
              <?php
                $terkini2=mysql_query("SELECT * FROM berita ORDER BY id_berita");
                $no=1;
...
elseif ($_GET['module']=='semuaberita'){
  ...
  $sql=mysql_query("select count(komentar.id_komentar) as jml, judul, jam, 
...
elseif ($_GET['module']=='detailalbum'){
  echo "<div id='content'>          
		  ...
		  ?>
		     <div class="art-postmetadataheader">
                                                <h2 class="art-postheader">
                                                  <a href=semua-album.html> &nbsp;Album</a>
                                                </h2>
                                            </div>
											<?php
  $p      = new Paging6;
...
elseif ($_GET['module']=='hubungikami'){
  ...
  echo "
  <fieldset>
      <legend><h3><u><b>Hubungi kami secara online dengan mengisi form dibawah ini:</b><br><br></u></h3></legend>
        <table width=100%>
...
elseif (empty($pesan)){
  ...
  mysql_query("INSERT INTO hubungi(nama,
                        ...
                        VALUES('$_POST[nama]',
                               ...
                               '$_POST[pesan]',
                               '$tgl_sekarang')"); 
  echo "<h3>Terimakasih telah menghubungi kami. <br /> Pasti akan Kami Balas :)</h3>";
		}else{
